...
return [
    ...
    'info' => [
         ...
         */
        'description' => "API REST d'Immo-Prestige (annonces, abonnements, messagerie temps réel). "
            ."Authentification par Bearer token (Sanctum) — voir /api/v1/auth/login. "
            ."Toutes les réponses sont enveloppées dans {\"data\": ...}; les erreurs métier "
            .'renvoient {"message", "code"} avec un statut HTTP explicite (401/403/404/409/422/402).',
    ],

    'ui' => [
        'title' => 'Immo-Prestige API',
    ],
    ...
    // No 'web' group: this is a stateless API with no session/CSRF, so the
    // docs gate (see AppServiceProvider -> Gate::define('viewApiDocs')) is a
    // plain env flag rather than a session-authenticated admin check.
    'middleware' => [
